...
bool RecastManaged::Recast::Recast::Recast::BuildCompactHeightfield(int walkableHeight, int walkableClimb,
                                                                    Heightfield^ hf,
...
bool RecastManaged::Recast::Recast::Recast::BuildHeightfieldLayers(int walkableHeight, int borderSize,
                                                                   CompactHeightfield^ chf,
...
bool RecastManaged::Recast::Recast::Recast::CreateHeightfield(int width, int height, array<float>^ bmin,
...
bool RecastManaged::Recast::Recast::Recast::CreateHeightfield(int width, int height,
...
bool RecastManaged::Recast::Recast::Recast::ErodeWalkableArea(int radius, CompactHeightfield^ chf)
{
	return rcErodeWalkableArea(_context, radius, *chf->GetPointer());
}

void RecastManaged::Recast::Recast::Recast::FilterLedgeSpans(int walkableHeight, int walkableClimb, Heightfield^ solid)
{
	rcFilterLedgeSpans(_context, walkableHeight, walkableClimb, *solid->GetPointer());
}

void RecastManaged::Recast::Recast::Recast::FilterLowHangingWalkableObstacles(int walkableClimb, Heightfield^ solid)
{
	rcFilterLowHangingWalkableObstacles(_context, walkableClimb, *solid->GetPointer());
}

void RecastManaged::Recast::Recast::Recast::FilterWalkableLowHeightSpans(
	int walkableHeight, Heightfield^ solid)
{
	rcFilterWalkableLowHeightSpans(_context, walkableHeight, *solid->GetPointer());
}

//void RecastManaged::Recast::Recast::Recast::MarkConvexPolyArea(array<float>^ verts, float heightMin, float heightMax,
...
void RecastManaged::Recast::Recast::Recast::MarkConvexPolyArea(array<float>^ verts,
                                                               int nverts,
                                                               float heightMin,
                                                               float heightMax,
                                                               int area,
...
bool RecastManaged::Recast::Recast::Recast::RasterizeTriangles(array<float>^ vertices,
                                                               int* tris,
                                                               int ntris,
